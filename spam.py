...
class spam():
    ...
    def team_seekers_spam(self, text):
    # !git clone 'https://github.com/jrangu/Datasets.git' 
    # !unzip /content/Datasets/randomforest.zip
...
# a.team_seekers_spam("Media fawns over Biden\'s Cabinet rollout, describes being rescued from this craziness by superheroes")